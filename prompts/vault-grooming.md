...
- **No subagent delegation.** Do all work in the main agent context. Grooming touches many files across both vaults — subagents hang on large orphan/fix batches. The `rg`-first approach keeps everything fast and predictable.
